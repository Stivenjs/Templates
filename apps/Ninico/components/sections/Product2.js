                    ...
                    <div className="row">
                            ...
                            <div className="tpproductnav tpnavbar">
                                <nav>
                                    <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <button className={activeIndex == 4 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(4)}>Más Vendidos</button>
                                    </div>
                                </nav>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-2">
                            <div className="tpproductall">
                                <Link href="/shop">Ver Todo<i className="far fa-long-arrow-right" /></Link>
                            </div>
                        </div>
                    </div>
