...
export async function generateStaticParams() {
  return data.map((post) => ({ id: post.id.toString() }));
}

export default function BlogDetails({ params }) {
  const { id } = params;
  const blogPost = data.find((post) => post.id.toString() === id);
                          ...
                          <div className="col-lg-12">
                            <div className="postbox__content postbox__content-area mb-55">
                              <div className="postbox__meta mb-15">
                                ...
                                <span>
                                  <Link href="#">
                                    <i className="far fa-comment-alt" /> (04)
                                    Comments
                                  </Link>
                                </span>
                              </div>
                              ...
                              <p>
                                ...
                                laudantium, aperiam ipsquae ab illo inventore
                                veritatis et quasi architecto beatae vitae dicta
                                sunt explicabo. Nemo enim voluptatem voluptas
                        ...
                        <div className="row">
                            ...
                            <div className="postbox__content-area mb-60">
                              ...
                              <div className="postbox__text mb-30">
                                <p>
                                  ...
                                  was born and I will gives you a itself
                                  completed account of the system, and sed
                                  expounds the ut actual teachings of that
                                  greater{" "}
                                </p>
                          ...
                          <div className="col-lg-6 col-md-6">
                            <div className="postbox__meta-img w-img mb-60">
                              <img
                                src="/assets/img/blog/blog-in-02.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6 col-md-6">
                            <div className="postbox__meta-img mb-60">
                              <img
                                src="/assets/img/blog/blog-in-05.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                          <div className="col-lg-6 col-md-6">
                            <div className="postbox__meta-img mb-60">
                              <img
                                src="/assets/img/blog/blog-in-04.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                          ...
                          <div className="postbox__comment-box d-flex">
                            <div className="postbox__comment-info">
                              <div className="postbox__comment-avater mr-25">
                                <img
                                  src="/assets/img/blog/comments/comment-1.png"
                                  alt=""
                                />
                              </div>
                            </div>
                        ...
                        <li className="children mb-30">
                          <div className="postbox__comment-box d-flex">
                            <div className="postbox__comment-info">
                              <div className="postbox__comment-avater mr-25">
                                <img
                                  src="/assets/img/blog/comments/comment-2.png"
                                  alt=""
                                />
                              </div>
                            </div>
                            <div className="postbox__comment-text">
                              ...
                              <p>
                                Include anecdotal examples of your experience,
                                or things you took notice of that you <br />{" "}
                                feel others would find useful.
                              </p>
                              <div className="postbox__comment-reply">
                                <Link href="#">
                                  <i className="fas fa-reply-all" />
                        ...
                        <div className="row">
                          ...
                          <div className="col-xxl-12">
                            <div className="postbox__comment-btn ">
                              <button
                                type="submit"
                                className="tp-color-btn tp-btn banner-animation"
                              >
                                Post Comment
                              </button>
                            </div>
                ...
                <div className="col-xxl-4 col-xl-4 col-lg-5 col-md-12">
                  <div className="sidebar__wrapper pl-25 pb-50">
                    ...
                    <div className="sidebar__widget mb-55">
                      <h3 className="sidebar__widget-title mb-25">
                        Recent Post
                      </h3>
                      <div className="sidebar__widget-content">
                        <div className="sidebar__post rc__post">
                          ...
                          <div className="rc__post d-flex align-items-center">
                            <div className="rc__post-thumb">
                              <Link href="/blog-details">
                                <img
                                  src="/assets/img/blog/sidebar/blog-sm-4.jpg"
                                  alt="blog-sidebar"
                                />
                              </Link>
                            </div>
